...
import { fetchOrdersReadyForPrepare, sendOrderForPrepare } from '@/plugins/api-client';
...
export default function Home() {
  ...
  const { isLoading, data } = useQuery('ready-for-preparing', fetchOrdersReadyForPrepare);
  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      renderCell: (params: GridCellParams) => {
        return (
          <Button variant="outlined" color="primary" onClick={() => handleAction(params.row)}>
            Send For Prepare
          </Button>
        );
      },
